...
public class Instruction {
     ...
     * <p/>
     * for default code table, the mode can be hold in one signed byte.
     * however, if use a specify code table with large same_size and near_size, the mode may need
     * one unsigned char to hold, so we use short here
     */
    private short mode;
